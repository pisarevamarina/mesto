...
function formSubmitHandler(evt) {                // эта функция вставляет в поля на странице пользовательские данные из формы,
...
function renderCards(obj) {                                   //ф-я создания новой карточки
...
function cardFormSubmitHandler(evt) {             //ф-я формы добавления  пользовательских карточек
